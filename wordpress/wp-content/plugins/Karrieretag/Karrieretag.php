...
/*
    ...
    Description: Karrieretag magazin plugin
    Version: 1.0.0
    Author: Jakub Wilk, Simon Schubert, Mihaela Popadic
 */
...
//First Step
    ...
    function addToEndOfPost($content){
        if(is_single() && is_main_query()){
            return $content . '<p> My name is Jakub.</p>';
        }
        return $content;
    }*/
...
//Second Step
    class WordCountAndTimePlugin {
        ...
        function readtimeHTML(){ ?>
            <input type="checkbox" name = "wcp_readtime" value="1" <?php checked(get_option('wcp_readtime')) ?></input>
        <?php }

        function charactercountHTML(){ ?>
            <input type="checkbox" name = "wcp_charactercount" value="1" <?php checked(get_option('wcp_charactercount')) ?></input>
         <?php }

        function wordcountHTML(){ ?>
            <input type="checkbox" name = "wcp_wordcount" value="1" <?php checked(get_option('wcp_wordcount')) ?></input>
        <?php }*/
