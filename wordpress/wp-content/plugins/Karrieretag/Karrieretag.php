...
echo '<script src="../wp-content/plugins/Karrieretag/js/javascript.js"></srcipt>';
...
class KarrieretagPlugin
{
    ...
    {
        // display "Karrieretag" as a title
        ...
        for ($i = 0; $i < count($this->find_forms_on_website()); $i++) {
            ...
            if (isset($POST["_" . $form_name . "_"])) {
                echo "<span class='box'><label class='check-label'><input class='checkbox' onclick='change($i)' type='checkbox' name='$form_name'><div class='check-design'></div> " . "<div class='text'>" . $form_name . "</div></label>" . "<div class='wrapper'><div class='file-export'><a href='../wp-content/plugins/Karrieretag/exportData.php?dbTable=" . $form_name . "'>Export</a><i class='uil uil-arrow-up'></i></div></div></span>" . "<br>";
            } else {
                echo "<span class='box'><label class='check-label'><input class='checkbox' onclick='change($i)' type='checkbox' name='$form_name'><div class='check-design'></div> " . "<div class='text'>" . $form_name . "</div></label>" . "<div class='wrapper'><div class='file-export'><a href='../wp-content/plugins/Karrieretag/exportData.php?dbTable=" . $form_name . "'>Export</a><i class='uil uil-arrow-up'></i></div></div></span>" . "<br>";
            }
